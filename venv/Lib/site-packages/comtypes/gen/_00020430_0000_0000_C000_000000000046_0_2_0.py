...
IFontDisp = Font
__all__ = [ 'OLE_YPOS_CONTAINER', 'FONTUNDERSCORE', 'Unchecked',
           'StdPicture', 'LoadPictureConstants', 'OLE_XSIZE_PIXELS',
           'OLE_CANCELBOOL', 'IPictureDisp', 'IFontDisp',
           'OLE_XSIZE_CONTAINER', 'FONTSTRIKETHROUGH', 'FONTNAME',
           'Monochrome', 'IFontEventsDisp', 'Color', 'FONTITALIC',
           'OLE_COLOR', 'OLE_YSIZE_PIXELS', 'OLE_YSIZE_HIMETRIC',
           'FONTSIZE', 'OLE_XPOS_PIXELS', 'IFont', 'Gray',
           'OLE_HANDLE', 'StdFont', 'OLE_YPOS_HIMETRIC',
           'OLE_XSIZE_HIMETRIC', 'Default', 'Font',
           'OLE_XPOS_CONTAINER', 'OLE_ENABLEDEFAULTBOOL', 'Picture',
           'OLE_TRISTATE', 'FONTBOLD', 'FontEvents',
           'OLE_YPOS_PIXELS', 'OLE_YSIZE_CONTAINER', 'VgaColor',
           'OLE_OPTEXCLUSIVE', 'Checked', 'IPicture',
           'OLE_XPOS_HIMETRIC']
